package com.example.adapter.notAdapter

import com.example.adapter.adapter.AppImage
import com.example.adapter.adapter.ResponseJSON
...
class ImageNotAdapter() {
    ...
    fun getPhoto(callback: (ResponseJSON) -> Unit) {
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                callback(jsonAdapterResponse.fromJson(jsonString)!!)
            }
        })
    }
}